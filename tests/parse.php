...
<body<?php if ($map) {
    print ' onload="init_' . $map . '()" class="iframe"';
} ?>>
...
<?php else: ?>
    ...
    <table class="performance">
        <tr>
            <td>Open file:</td>
            <td><?php print number_format($open_file_time * 1000, 3); ?> ms</td>
        </tr>
        <tr>
            <td>Parse:</td>
            <td> <?php print number_format($parse_time * 1000, 3); ?> ms</td>
        </tr>
        <tr>
            <td>Generate KML:</td>
            <td> <?php print number_format($generate_kml_time * 1000, 3); ?> ms</td>
        </tr>
        <tr>
            <td>Generate WKT:</td>
            <td> <?php print number_format($generate_wkt_time * 1000, 3); ?> ms</td>
        </tr>
        <tr>
            <td>Generate GeoJSON:</td>
            <td> <?php print number_format($generate_json_time * 1000, 3); ?> ms</td>
        </tr>
        <tr>
            <td class="bold">TOTAL:</td>
            <td class="bold"> <?php print number_format($total_procress_time * 1000, 3); ?> ms</td>
        </tr>
    </table>
